...
const TextHover = ({ header, headerStroke, body, bodyStroke, right }) => {
    ...
    return (
        <motion.h2
            className={clsx("relative text-white group e text-8xl lg:w-[80%] lg:mx-auto tracking-[7.5px] border-y-2 py-10")}
            id="text-topic"
            ref={textHeadRef}
        ...
        >
            <div
                className={clsx(
                    " h-full bg-yellow-700 mix-blend-difference transition-all duration-500 absolute w-0 group-hover:w-full top-0 right-0 group-hover:left-0"
